...
<body>
    ...
    <div id="request_start_rental">
        ...
        <?php  
    echo date("d M", strtotime($from)). " - ".date("d M Y", strtotime($to));;  
?></div>
        <div id="req_btn">
...
?></div>
    ...
    <input type="text" name="fname" value="<?php echo $_POST['shipment_address'];?> " readonly style="width: 90%; margin:10px;" />
    ...
    <a  id="reject" class="bigfont" href="reject-rental.php?id=<?php echo $_POST['rId'];?>" style="text-decoration: none; color:white;">
    Reject
            
</a>
        <a  id="accept" class="bigfont" href="accept-rental.php?id=<?php echo $_POST['rId'];?>" style="text-decoration: none; color:white;">
            Accept
