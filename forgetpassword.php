...
// </script>";
 ...
 $msg='<div class="alert alert-success" role="alert">'.$obj['message'].'
</div>';
...
<form method="post" action="" enctype="multipart/form-data">
   ...
   <input type="hidden" name="one" value=<?php echo $_SESSION['otp']; ?>>
                ...
                <div class="input-container1">
                    ...
                    <input type="text" class="typecol" placeholder="Password" height="100%"  autocomplete="off" name="pass1" style="margin-top:0px;margin-bottom:0px; width:100%;">
                ...
                <div class="input-container1">
                    <!-- <div style="width:100%;display: flex;justify-content:center;align-items:center;height: 100%;background: #0275d8;"><i class="fa fa-key icon"></i></div> -->
                    <input type="text" class="typecol" placeholder="Confirm Password" height="100%" name="c_pass" autocomplete="off" style="margin-top:0px;margin-bottom:0px; width:100%;">
                    <div style="width:100%;display: flex;justify-content:center;align-items:center;height: 100%;"><i class="fa-solid fa-eye"></i></div>

                </div>

                <div style="margin-top:15px;width:100%;display: flex;justify-content:center;align-items:center;height: 100%;">
                    <button id="btn1log" style="text-decoration:none;color:white;font-size:22px" type="submit" name="save">Save</button>
                </div>
                </form>
            </div>
            </div>
