    ...
    <div class="signupcontent">
        ...
        <form method="post" action="" enctype="multipart/form-data">
            <div style="display:flex;justify-content:center">
                <div class="div1">
                    <img src="<?php echo  $_SESSION['image']; ?>" class="main-profile-img" id="output" />
                    <div class="div2">
                        <i class="fa fa-edit" type="file" multiple="" data-max_length="10" class="upload__inputfile"><input type="file" name="fileToUpload" data-max_length="10" class="upload__inputfile" style="opacity: 0;" onchange="loadFile(event)"> </i>
                    </div>
                </div>
                <script>
  var loadFile = function(event) {
    ...
    output.onload = function() {
      URL.revokeObjectURL(output.src) // free memory
            ...
            <input type="email" class="typecol" name="email" readonly value=<?php echo
                                                                    $_SESSION['email']; ?>>
            ...
            <div class="size-204 mt-3 mb-3">
                ...
                <textarea placeholder="Discription"  class="typecol" name="description" style="background-color: #fff; border: 1px solid #e6e6e6; color: #888; width: 100%; padding: 10px; border-radius: 3px; margin: 5px 0; display: inline-block; font-size: 14px; text-decoration: none;"></textarea>
