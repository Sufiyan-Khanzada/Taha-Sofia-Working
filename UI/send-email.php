        ...
        <div class="containerlogin1">
            ...
            <div style="width:90%;margin: auto;">
                <div class="input-container">
                    ...
                    <input type="email" id="disabledTextInput" class="form-control" placeholder="example@gmail.com" style="margin-top:0px;margin-bottom:0px; width:100%;">
                ...
                <div style="margin-top:15px;width:100%;display: flex;justify-content:center;align-items:center;height: 100%;">
                    <button id="btn1log"><a href="update.php" style="text-decoration:none;color:white;font-size:22px">Send</a></button>
                </div>
            </div>
            </div>
        </div>
