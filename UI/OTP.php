        ...
        <div class="containerlogin1">
            ...
            <div style="width:90%;margin: auto;">
                ...
                <input type="number" id="digit-1" name="digit-1" data-next="digit-2" />
                        ...
                        <input type="number" id="digit-4" name="digit-4" data-next="digit-4" data-previous="digit-3" maxlength="1" />
                        </div>
                        <div id="digit-5" style="margin-top:15px;display: flex;justify-content:center;align-items:center;">
                    <button id="btn1log" type="submit"  style="width:25%;height: 50px;text-decoration:none;color:white;font-size:17px">Submit</button>
                </div>
                    </form>
