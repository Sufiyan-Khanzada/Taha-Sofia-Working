...
?>
                <a href="#" class="dis-block icon-header-item cl2 hov-cl1 trans-04 p-r-11 p-l-10 icon-header-noti" data-notify="<?php echo  $count_index_fav ?>">
                    <i class="zmdi zmdi-favorite-outline"></i>
                </a>
			</div>
			...
			<div class="row isotope-grid">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?php  echo $user->Item_image?>" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14" style="justify-content: center;">
							<div class="block2-txt-child1 flex-col-l ">
								 <a href='product-detail.php?id=<?php echo $user->id; ?>' class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
							...
							<div class="block2-txt-child2 flex-r p-t-3">
								<a href="add-fav.php?id=<?php echo $user->id; ?>" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2">
							...
							<div class="flex-c-m stext-106 cl6 size-104 bor4 pointer hov-btn4 trans-04 m-r-8 m-tb-4">
						            <i class="icon-close-filter cl2 m-r-6 fs-15 trans-04 zmdi zmdi-close dis-none"></i>
                                     <a href='product-detail.php?id=<?php echo $user->id; ?>' style="text-decoration: none; padding:8px; ">€ <?php echo $user->Item_price ?>/Day</a> 
					            </div>
						</div>
					</div>
				</div>
