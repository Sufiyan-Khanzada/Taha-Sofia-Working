...
$target_file = $target_dir . basename($_FILES["item_im"]["name"]);
move_uploaded_file($_FILES["item_im"]["tmp_name"], $target_file);

$target_dir1 = "uploads/featured/";
$target_file1 = $target_dir1 . basename($_FILES["feat_im"]["name"]);
move_uploaded_file($_FILES["feat_im"]["tmp_name"], $target_file1);

$target_dir2 = "uploads/damage/";
$target_file2 = $target_dir2 . basename($_FILES["damageimg"]["name"]);
move_uploaded_file($_FILES["damageimg"]["tmp_name"], $target_file2);

$target_dir3 = "uploads/proof/";
$target_file3 = $target_dir3 . basename($_FILES["proofimg"]["name"]);
move_uploaded_file($_FILES["proofimg"]["tmp_name"], $target_file3);
    ...
    $image=$target_file;
    $featimg=$target_file1;
    
    $dmgimage=$target_file2;
    $proofimg=$target_file3;
                      ...
                      <div class="upload__btn-box">
                        <div style="display: flex;justify-content:center">
                          <label class="upload__btn">
                            <p>Upload images</p>
                            <input type="file" name="feat_im"  data-max_length="10" required class="feature_inputfile">
                          </label>
                        </div>
                      </div>
                    ...
                    <div class="upload__box">
                      <div class="upload__btn-box">
                        <div style="display: flex;justify-content:center">
                          <label class="upload__btn">
                            <p>Upload images</p>
                            <input type="file" name="item_im"  data-max_length="10" required class="upload__inputfile">
                          </label>
                        </div>
                      </div>
                    ...
                    <div class="upload__box">
                      <div class="upload__btn-box">
                        <div style="display: flex;justify-content:center">
                          <label class="upload__btn">
                            <p>Upload images</p>
                            <input type="file" multiple="" name="damageimg" data-max_length="10" class="upload__inputfile1">
                          </label>
                        </div>
                      </div>
                    ...
                    <div class="upload__box">
                      <div class="upload__btn-box">
                        <div style="display: flex;justify-content:center">
                          <label class="upload__btn">
                            <p>UPLOAD</p>
                            <input type="file" multiple="" name="proofimg" data-max_length="10" class="upload__inputfile">
                          </label>
                        </div>
                      </div>
                      <div class="upload__img-wrap"></div>
