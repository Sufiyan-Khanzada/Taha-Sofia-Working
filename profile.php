...
<div>        
        ...
        <span>@glatzekatze</span></div>
                <div class="d-flex flex-row justify-content-center align-items-center gap-2">
                    <span class="idd1 st1">
<?php 
                    include 'review-by-user-branded-main.php';
                    ?>
                    <span class="idd1 st1">
                    
                        <?php
                    $round=0;
                        if($user_data_featured!=""){
                      ...
                      ?>
                        ...
                        </span><span class="idd1" style="color:black;">(<?php echo $round; ?>)</span>
                        </div>
...
<?php 
    ...
    <div class="stext-102" id="#" style="margin: 10px 20px;"><?php echo (isset($_SESSION['description']))?($_SESSION['description']):($_SESSION['description']="Description is not Set"); ?></div>
    <!-- accordation start -->
    ...
    <ul class="list-group" style="margin-top: 20px;">
        ...
        <a href="logout.php" class="ancacc"><li class="list-group-item ">Logout <span style="float: right;"><i class="fa fa-angle-right"></i></span></li></a>
